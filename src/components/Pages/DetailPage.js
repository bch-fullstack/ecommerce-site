                            ...
                            <div className="col-lg-12">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item"><a href="#">Ladies</a></li>
                            ...
                            <div className="col-lg-9 order-1 order-lg-2">
                                <div id="productMain" className="row">
                                    <div className="col-md-6">
                                        <div data-slider-id="1" className="owl-carousel shop-detail-carousel">
                                            <div className="item"> <img src="img/detailbig1.jpg" alt="" className="img-fluid" /></div>
                                            <div className="item"> <img src="img/detailbig2.jpg" alt="" className="img-fluid" /></div>
                                            <div className="item"> <img src="img/detailbig3.jpg" alt="" className="img-fluid" /></div>
                                        </div>
                                    ...
                                    <div className="col-md-6">
                                        <div className="box">
                                            ...
                                            <p className="goToDescription"><a href="#details" className="scroll-to">Scroll to product details, material &amp; care and sizing</a></p>
                                            <p className="price">$124.00</p>
                                            <p className="text-center buttons"><a href="basket.html" className="btn btn-primary"><i className="fa fa-shopping-cart"></i> Add to cart</a><a href="basket.html" className="btn btn-outline-primary"><i className="fa fa-heart"></i> Add to wishlist</a></p>
                                        </div>
                                        <div data-slider-id="1" className="owl-thumbs">
                                            <button className="owl-thumb-item"><img src="img/detailsquare.jpg" alt="" className="img-fluid" /></button>
                                            <button className="owl-thumb-item"><img src="img/detailsquare2.jpg" alt="" className="img-fluid" /></button>
                                            <button className="owl-thumb-item"><img src="img/detailsquare3.jpg" alt="" className="img-fluid" /></button>
                                        </div>
                                    </div>
                                </div>
                                <div id="details" className="box">
                                    ...
                                    <div className="social">
                                        ...
                                        <p><a href="#" className="external facebook"><i className="fa fa-facebook"></i></a><a href="#" className="external gplus"><i className="fa fa-google-plus"></i></a><a href="#" className="external twitter"><i className="fa fa-twitter"></i></a><a href="#" className="email"><i className="fa fa-envelope"></i></a></p>
                                    </div>
                                </div>
